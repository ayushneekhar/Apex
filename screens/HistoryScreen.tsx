...
function getSessionDurationLabel(session: WorkoutSession): string {
  return session.durationMs === null ? 'Legacy' : formatDuration(session.durationMs);
}
            ...
            <View
              ...
              <View style={styles.statChips}>
                ...
                <View
                  ...
                  <AppText>{getSessionDurationLabel(item.session)}</AppText>
                </View>
              </View>
