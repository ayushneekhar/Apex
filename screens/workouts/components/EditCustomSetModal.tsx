    ...
    >
      <View style={styles.backdrop}>
        ...
        >
            ...
            <>
              ...
              <View style={styles.scopeTabs}>
                {weightApplyScopeOptions.map((option) => {
                  const isSelected =
                    option.value === controller.customWeightApplyScope;

                  return (
                    <Pressable
                      key={option.value}
                      onPress={() =>
                        controller.setCustomWeightApplyScope(option.value)
                      }
                      style={[
                        styles.scopeTab,
                        {
          ...
          {controller.customSetError ? (
            <ErrorNotice message={controller.customSetError} />
          ) : null}
          ...
          <View style={styles.actions}>
            <View style={styles.actionCell}>
              <NeonButton
                title="Cancel"
                variant="ghost"
                onPress={controller.closeCustomSetModal}
              />
            </View>
            <View style={styles.actionCell}>
              <NeonButton
                title="Save"
                onPress={() => void controller.saveCustomSetValues()}
              />
            </View>
          </View>
        </View>
